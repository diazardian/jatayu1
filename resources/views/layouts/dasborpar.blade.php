...
<head>
    ...
    <link href="{{ asset('aset-adminvendor/datatables/dataTables.bootstrap4.css') }}" rel="stylesheet">
...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <div class="logo">
        <img class="logo-img logo-img-main" src="{{asset('img/logologo.png')}}">
    </div>
...
<script src="{{ asset('aset-admin/js/sb-admin.min.js') }}"></script>
